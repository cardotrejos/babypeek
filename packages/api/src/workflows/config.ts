...
export const PROMPT_V3_JSON = JSON.stringify({
  ...
  negatives: [
    ...
    "over-smoothed skin", "over-sharpened", "HDR look", "extra fingers",
    "missing fingers", "fused fingers", "duplicated facial features", "warped anatomy",
  ],
}, null, 2)
...
export const PROMPT_V4_JSON = JSON.stringify({
  ...
  negatives: [
    ...
    "over-smoothed skin", "over-sharpened", "HDR look", "extra fingers",
    "missing fingers", "fused fingers", "duplicated facial features", "warped anatomy",
    "tight face crop only", "missing womb context", "no visible womb membrane",
