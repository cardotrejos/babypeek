...
describe("PurchaseService", () => {
  ...
  const MockStripeServiceLive = Layer.succeed(
    StripeService,
    mockStripeService as unknown as StripeService["Type"],
  );
  ...
  describe("createCheckout", () => {
    it("should create checkout session for completed upload", async () => {
      ...
      mockStripeService.createCheckoutSession.mockReturnValue(Effect.succeed(mockStripeSession));
