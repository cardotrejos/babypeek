...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: `View your free preview. Upgrade to HD (from ${PRICING_TIERS.basic.priceDisplay}) to download and share the high-resolution portrait.`,
      position: 3,
    },
  ],
  totalTime: "PT2M",
...
const steps = [
  ...
  },
  {
    ...
    description:
      `Get an instant free preview of your baby's portrait. Upgrade to HD (from ${PRICING_TIERS.basic.priceDisplay}) for the full high-resolution download. Send to family and friends with a unique shareable link.`,
    tips: [
      "Free: get an instant preview",
      `HD (from ${PRICING_TIERS.basic.priceDisplay}): full high-resolution download`,
