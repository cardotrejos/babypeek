...
describe("RevealAnimation", () => {
  ...
  describe("Initial State (AC-1)", () => {
    ...
    it("should render the image with correct alt text", () => {
      render(<RevealAnimation imageUrl="https://example.com/image.jpg" alt="Custom alt text" />);
  ...
  describe("UI Delay (AC-4)", () => {
    ...
    it("should show UI after delay when showUI is managed externally", () => {
      const { rerender } = render(
        <RevealAnimation imageUrl="https://example.com/image.jpg" showUI={false} />,
      );
      ...
      rerender(<RevealAnimation imageUrl="https://example.com/image.jpg" showUI={true} />);
  ...
  describe("Cleanup", () => {
    it("should clean up timeouts on unmount", () => {
      const { unmount } = render(<RevealAnimation imageUrl="https://example.com/image.jpg" />);
