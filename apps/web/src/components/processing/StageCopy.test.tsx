...
describe("StageCopy", () => {
  ...
  it("shows first sub-copy initially", () => {
    ...
    expect(screen.getByText("Finding your baby's unique features")).toBeInTheDocument();
  });
  ...
  it("resets sub-copy when stage changes", () => {
    ...
    expect(screen.getByText("Our AI is working its magic")).toBeInTheDocument();
  });

  it("applies custom className", () => {
    const { container } = render(<StageCopy uiStage="analyzing" className="test-class" />);
